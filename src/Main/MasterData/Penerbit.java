...
public class Penerbit extends javax.swing.JFrame {
    protected String selectedPenerbitID;
    /**
    ...
    private void initComponents() {
        ...
        ZeroLayout3.add(btnBook_reset, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 300, 65, 30));
        ...
        ZeroLayout3.add(btnBook_delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 300, 65, 30));
        ...
        ZeroLayout3.add(btnBook_submit, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 300, 65, 30));
        ...
        ZeroLayout3.add(btnBook_save, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 300, 65, 30));
        ...
        ZeroLayout3.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 170, -1, 30));
        ...
        ZeroLayout3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, 300, -1));
    ...
    private void btnBook_submitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBook_submitMouseClicked
        if(!txt_nama.getText().equals("") && !txt_alamat.getText().equals("")) {
            if(this.selectedPenerbitID != null) {
                ...
                try {
                    String query = "INSERT INTO penerbit (id_penerbit, nama, alamat) VALUES (NULL, '" + nama + "', '" + alamat + "')";
                    Connection conn = (Connection)Database.GetConnection();
                    PreparedStatement ps = conn.prepareStatement(query);
                    ps.execute();
                    ps.close();
    ...
    private void btnBook_saveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBook_saveMouseClicked
        if(this.selectedPenerbitID == null) {
            ...
            try {
                ...
                String query = "UPDATE penerbit SET nama = '" + nama + "', alamat = '" + alamat + "' WHERE id_penerbit = '" + this.selectedPenerbitID + "'";
                Connection conn = (Connection)Database.GetConnection();
                PreparedStatement ps = conn.prepareStatement(query);
                ps.execute();
                ps.close();
    ...
    private void txt_cariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_cariKeyReleased
        try {
            ...
            String query = "SELECT * FROM penerbit WHERE CONCAT(id_penerbit, nama, alamat) LIKE '%" + input + "%'";
            Connection conn = (Connection)Database.GetConnection();
            PreparedStatement ps = conn.prepareStatement(query);
            ResultSet result = ps.executeQuery();
